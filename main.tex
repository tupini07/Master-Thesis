...
It is also interesting to see how the features for training samples vary if they're labelled possitively or negatively. A hypothesis is that, as stated in \autoref{sec:training-real-data-difference}, already labeled items are more likely to have the rest of their information filled out, so the expected output is that features for this items are more informative.
