...
To understand the features exposed in the last function better, and to learn what is their behaviour in a real world scenario, this section will proceed to mention some basic statistical information about them. Of special interest is: which is the average value for a feature, which features are always zero, and knowledge of the features that are applied for a specific catalog. This information will be separated by concrete entity and also by whether the feature comes from a training set or a classification set. 

It is also interesting to see how the features for training samples vary if they're labelled positively or negatively. A hypothesis is that, as stated in \autoref{sec:training-real-data-difference}, already labeled items are more likely to have the rest of their information filled out, so the expected output is that features for this items are more informative.

The first case that will be analyzed is the training set as a whole vs the classification set. Later a new table will be presented that shows the positive examples vs the negative examples in the training set 
...
\begin{tabular}{llllllllll}
                                     & D/band & D/musician & I/actor & I/director & I/musician & I/producer & I/writer & M/band & M/musician \\
born\_similar                        &              &                  & 0.005      & 0.006         & 0.003         & 0.005         & 0.005       & 0.000            & 0.006                \\
description\_cosine                  & 0.010        & 0.013            &            &               &               &               &             &                  &                      \\
died\_similar                        &              &                  & 0.001      & 0.001         & 0.001         & 0.002         & 0.003       & 0.000            & 0.001                \\
name\_exact                          & 0.077        & 0.040            & 0.107      & 0.091         & 0.042         & 0.122         & 0.070       & 0.140            & 0.051                \\
name\_levenshtein            & 0.544        & 0.658            & 0.467      & 0.457         & 0.452         & 0.465         & 0.452       & 0.489            & 0.470                \\
name\_tokens\_shared                 & 0.307        & 0.197            & 0.306      & 0.321         & 0.278         & 0.317         & 0.265       & 0.402            & 0.285                \\
name\_cosine & 0.527        & 0.437            & 0.554      & 0.549         & 0.510         & 0.551         & 0.511       & 0.608            & 0.515                \\
occupations\_shared                  &              &                  & 0.014      & 0.123         & 0.103         & 0.033         & 0.017       &                  &                      \\
url\_exact                           & 0.001        & 0.001            &            &               &               &               &             & 0.035            & 0.006                \\
url\_tokens\_shared                  & 0.012        & 0.004            &            &               &               &               &             & 0.047            & 0.008               
\end{tabular}
\caption{Features extracted for classification dumps.}
\label{tab:my-table}
\end{table}
...
\centering
\begin{tabular}{llllllllll}
                                     & discogs/band & discogs/musician & imdb/actor & imdb/director & imdb/musician & imdb/producer & imdb/writer & musicbrainz/band & musicbrainz/musician \\
born\_similar                        &              &                  & 0.121      & 0.090         & 0.089         & 0.088         & 0.112       & 0.000            & 0.175                \\
description\_cosine                  & 0.028        & 0.037            &            &               &               &               &             &                  &                      \\
died\_similar                        &              &                  & 0.043      & 0.036         & 0.038         & 0.032         & 0.053       & 0.000            & 0.060                \\
name\_exact                          & 0.316        & 0.247            & 0.205      & 0.183         & 0.177         & 0.177         & 0.186       & 0.285            & 0.234                \\
name\_tokens\_levenshtein            & 0.622        & 0.732            & 0.475      & 0.462         & 0.468         & 0.466         & 0.464       & 0.547            & 0.511                \\
name\_tokens\_shared                 & 0.457        & 0.264            & 0.291      & 0.290         & 0.262         & 0.234         & 0.246       & 0.447            & 0.303                \\
name\_tokens\_string\_kernel\_cosine & 0.641        & 0.494            & 0.541      & 0.526         & 0.506         & 0.484         & 0.499       & 0.641            & 0.535                \\
occupations\_shared                  &              &                  & 0.028      & 0.209         & 0.185         & 0.137         & 0.141       &                  &                      \\
url\_exact                           & 0.065        & 0.038            &            &               &               &               &             & 0.195            & 0.157                \\
url\_tokens\_shared                  & 0.127        & 0.078            &            &               &               &               &             & 0.122            & 0.108               
\end{tabular}
\caption{Features extracted for training dumps.}
\label{tab:my-table}
\end{table}
...
\begin{tabular}{llllllllll}
                                     & discogs/band & discogs/musician & imdb/actor & imdb/director & imdb/musician & imdb/producer & imdb/writer & musicbrainz/band & musicbrainz/musician \\
born\_similar                        &              &                  & 0.683      & 0.538         & 0.588         & 0.581         & 0.659       & 0.000            & 0.800                \\
description\_cosine                  & 0.057        & 0.102            &            &               &               &               &             &                  &                      \\
died\_similar                        &              &                  & 0.244      & 0.218         & 0.253         & 0.217         & 0.318       & 0.000            & 0.278                \\
name\_exact                          & 0.945        & 0.987            & 0.953      & 0.955         & 0.966         & 0.964         & 0.963       & 0.968            & 0.977                \\
name\_tokens\_levenshtein            & 0.758        & 0.885            & 0.527      & 0.525         & 0.541         & 0.529         & 0.525       & 0.729            & 0.609                \\
name\_tokens\_shared                 & 0.774        & 0.584            & 0.589      & 0.606         & 0.549         & 0.495         & 0.511       & 0.786            & 0.590                \\
name\_tokens\_string\_kernel\_cosine & 0.883        & 0.816            & 0.813      & 0.819         & 0.785         & 0.755         & 0.774       & 0.895            & 0.802                \\
occupations\_shared                  &              &                  & 0.073      & 0.458         & 0.470         & 0.369         & 0.324       &                  &                      \\
url\_exact                           & 0.218        & 0.172            &            &               &               &               &             & 0.819            & 0.732                \\
url\_tokens\_shared                  & 0.398        & 0.328            &            &               &               &               &             & 0.468            & 0.488               
\end{tabular}
\caption{Features extracted for positive training samples (those labelled as matches).}
\label{tab:my-table}
\end{table}
...
\begin{tabular}{llllllllll}
                                     & discogs/band & discogs/musician & imdb/actor & imdb/director & imdb/musician & imdb/producer & imdb/writer & musicbrainz/band & musicbrainz/musician \\
born\_similar                        &              &                  & 0.005      & 0.004         & 0.004         & 0.003         & 0.005       & 0.000            & 0.007                \\
description\_cosine                  & 0.016        & 0.019            &            &               &               &               &             &                  &                      \\
died\_similar                        &              &                  & 0.001      & 0.001         & 0.001         & 0.001         & 0.001       & 0.000            & 0.001                \\
name\_exact                          & 0.057        & 0.045            & 0.050      & 0.036         & 0.042         & 0.043         & 0.034       & 0.075            & 0.033                \\
name\_tokens\_levenshtein            & 0.566        & 0.691            & 0.464      & 0.450         & 0.456         & 0.456         & 0.452       & 0.491            & 0.484                \\
name\_tokens\_shared                 & 0.327        & 0.176            & 0.229      & 0.230         & 0.213         & 0.190         & 0.194       & 0.343            & 0.226                \\
name\_tokens\_string\_kernel\_cosine & 0.541        & 0.407            & 0.485      & 0.471         & 0.458         & 0.437         & 0.445       & 0.563            & 0.462                \\
occupations\_shared                  &              &                  & 0.018      & 0.162         & 0.136         & 0.097         & 0.105       &                  &                      \\
url\_exact                           & 0.001        & 0.002            &            &               &               &               &             & 0.002            & 0.001                \\
url\_tokens\_shared                  & 0.015        & 0.010            &            &               &               &               &             & 0.015            & 0.005               
\end{tabular}
\caption{Features extracted for negative training samples (those labelled as not matches).}
\label{tab:my-table}
\end{table}
...
\begin{figure}[]
  ...
  \label{fig:distribution-of-classification-features}
\end{figure}

\begin{figure}[]
  \centering \includegraphics[width=\textwidth]{training_feature_distribution} 
  \caption{Feature distribution for the training set.}
  \label{fig:distribution-of-training-features}
\end{figure}

> note, separate trainingin positive and negative
...
This section might be removed, since correlation between features themselves is not very interesting. Would be better to do correlatino of features with predicted values, but I don't know if we have time for that. 
...
A potential problem with classification data coming from Wikidata is that the classification data is usually worst quality data than the training one. Elements in the training data, are probably more \textit{important} since somebody took the time to link them to the external catalog, and it can be reasonably believed that the other statements of these items have been filled as well. This makes the 


Consider an horizontal bar plot, showing the average values for features in classifications and in training.
% \^-- consider also make comparative distplots of each feature. There are many, 10 features to be exact, which could be separated into 2x5 subplots? .. Just compare all entities with the feature, no need to separate amongst catalogs and etc.

Also show if some are NaN in classification while not-nan in training (doubt it) 
...
% need to include introduction to what ML algorithms are and how they are trained? Most importantly, if this is done then take time to explain *generalization*
...
\todo[inline]{check if we can say which algorithms tend to have high variance and high bias. So that we can give a motivation for why which chose each for the ensemble part}
...
%Awesome ensembles page on GH has some nice links

% Should mention boosting even if're we're not using it?
...
This chapter presents the results obtained when evaluating the different model used, both baseline and ensembles. The evaluation results for both the baseline and ensemble classifiers presented in this section have been obtained by performing a 5-fold cross validation procedure on the training data. This process will be explained in the following section. The data used to generate this results was the Wikidata training dumps and the external catalog dumps mentioned in \autoref{sec:orig-shape-of-data}.
...
Note that this section includes only the results obtained during evaluation. \autoref{sec:apx-classification-results} contains information on the distributions obtained when predicting the classification sets.
...
In the table below are presented the performance metrics for each classifier applied to each concrete entity. Note that the names of the algorithms have been shortened to make the table fit nicely in the page. The abbreviations are as follow:
...
The results presented above are quite interesting since they show that features extracted for \textit{Musicbrainz/Musicians} are most definitely more informative than those for other concrete entities. This makes sense when one looks at (plot of features), it is clear that the information available for this case is much more than in others.


\begin{longtable}{|l|l|l|l|l|l|l|l|}
\hline
Catalog     & Model                             & Average F1 & Average F1.STD & Average Prec & Average Prec.STD & Average Recall & Average Recall.STD \\ \hline
...
The table below contains a summary of the metrics obtained by each classifier, these were obtained by averaging the metrics obtained for each concrete entity.  
