...
Voting based ensembles are a kind of \textit{bagging} ensembles \cite{zhou2012ensemble}. The name of bagging is short for \textit{bootstrapping} and \textit{aggregating}.
